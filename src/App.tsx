...
function App() {
  ...
  return (
    <div className=' w-full p-0 m-0'>
      ...
      {/* <div  className={`bg-[url(src/assets/hero_section.jpg)] h-screen w-screen `}></div> */}
        ...
        <img src={"/assets/Netflix_Logo_PMS.png"} className='w-auto h-12 md:h-20 z-[1] brightness-150' alt="asj" />
          <div className='flex flex-row h-7 md:h-10 gap-2 md:gap-8 '>
            ...
            <button className='rounded-lg bg-[#E50914] text-xs md:text-lg text-center py-0'>Sign in</button>
          </div>
        </div>
        <div className='z-[2] absolute top-[32%] w-full flex justify-center  '>
          <div className='max-w-[80%] md:max-w-[50%]'>
          <h2 className=' text-[2rem] md:text-[2.6rem] xl:text-[3.5rem] leading-[2.5rem] md:leading-[4rem] font-extrabold'>
            Unlimited movies, TV shows and more
          </h2>
          <p className='font-bold text-[1.4rem] md:mt-6'>
          Starts at ₹149. Cancel at any time.
          </p>
          <p className='font-medium text-[1rem] mt-4 md:mt-7'>
          Ready to watch? Enter your email to create or restart your membership.
          </p>
          <div className='flex flex-col justify-center items-center md:flex-row mt-4 gap-4'>
            <input type="email" autoComplete='email' className=' bg-transparent w-[100%] md:w-[70%] border border-gray-600 rounded-md pl-2 text-[1.4rem] h-[3.4rem] ' placeholder='Email address' />
      ...
      {/* movies list */}
  <div className='w-full mb-10  px-6 py-8 flex justify-center'>
      <div className="relative w-full md:w-[90%] ">
  <h2 className="text-xl md:text-2xl font-bold text-left text-white mb-4">Trending Now</h2>
...
>
    {moviesList.map((src, i) => (
      ...
      >
        ...
        {/* big rank number */}
        <span className="
          absolute -left-2 -bottom-2 text-[4rem] lg:text-[5rem]
          font-extrabold text-black card-number drop-shadow-[2px_2px_2px_rgba(0,0,0,.8)]
        ">
          {i + 1}
        </span>
      </div>
